...
$("#add").live("click", function(){
	$("#addOrUpdateInitForm").attr("action","renjia/addOrUpdateInit.do");
...
$("#servingUpdate").live("click", function(){
	...
	$("#addOrUpdateInitForm").attr("action","renjia/addOrUpdateInit.do?tradeExtraServing.id="+id);
	$("#addOrUpdateInitForm").submit();
});
/**
 * 详情
...
$("#detail").live("click", function(){
	var id = $(this).parent().prev().prev().val();
	$("#addOrUpdateInitForm").attr("action","renjia/detail.do?tradeExtraServing.id="+id);
	$("#addOrUpdateInitForm").submit();
});
/**
 * 删除
