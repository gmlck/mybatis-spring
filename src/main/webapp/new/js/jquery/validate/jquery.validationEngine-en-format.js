(function($) {
    var methods = {
        ...
        _validateField: function(field, options, skipAjaxValidation) {
            ...
            for (var i = 0; i < rules.length; i++) {
                ...
                case "funcCall":
                    ...
                    break;
                default:
                    errorMsg = methods._defFuncCall(field, rules, i, options);
                };
        ...
        _defFuncCall: function(field, rules, i, options) {var functionName = rules[i];var fn = window[functionName];  if (typeof(fn) == 'function') return fn(field, rules, i, options)},
        ...
        _closePrompt: function(field) {
            var prompt = methods._getPrompt(field);
            if (prompt) prompt.fadeTo("fast", 0,
            function() {
                prompt.remove()
            })
        },
